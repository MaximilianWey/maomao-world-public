...
playlistStore.fetchSubscribedPlaylists()
const { subscribedPlaylists } = storeToRefs(playlistStore)

watch(subscribedPlaylists, (newPlaylists) => {
...
<template>
  <PlaylistOverview :playlists="subscribedPlaylists" :show-create-card="false" :editable="false" />
</template>
