...
playlistStore.fetchPublicPlaylists()
const { publicPlaylists } = storeToRefs(playlistStore)

watch(publicPlaylists, (newPlaylists) => {
...
<template>
  <PlaylistOverview :playlists="publicPlaylists" :show-create-card="false" :editable="false" />
</template>
